 ...
 */
#define DISTRHO_PLUGIN_NAME "Native File Dialog Demo"
...
/**
   ...
   @note This macro is required.
 */
#define DISTRHO_PLUGIN_URI "anclark:DPF_NativeFileDialogDemo"
...
*/
#define DISTRHO_PLUGIN_CLAP_ID "anclark.test.nativefiledialog"
