...
protected:
    ...
    */
    ...
    {
        return "Plugin to show how to use Native File Dialog in DISTRHO Plugin Framework.";
    }
    ...
    */
    ...
    {
        return "https://github.com/AnClark/DPF-NativeFileDialogDemo";
    }
...
private:
    ...
    */
    DISTRHO_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(NativeFileDialogDemoPlugin)
};
...
Plugin* createPlugin()
{
    return new NativeFileDialogDemoPlugin();
}
